...
> **BLOQUEADO POR AHORA.** No ejecutar esta migración hasta que el Preview de `codex/omnichannel-admin-baseline-v1` tenga variables válidas, autenticación operativa y paridad visual confirmada por el usuario.
...
3. Solo después de levantar los bloqueos anteriores, abrir `supabase/migracion-omnichannel-commerce-core.sql`, copiarlo completo y pulsar **Run** una sola vez.
...
No pegar claves en chat. Tras guardarlas, ejecutar Redeploy sobre el Preview de `codex/omnichannel-admin-baseline-v1`.
