...
// Add specific Pucón keywords in FAQ
html = html.replace('Sí, despacho propio en todo Santiago con tarifas fijas.', 'Sí, despacho propio en todo Santiago y Pucón con tarifas fijas.');

// Update About Us
const oldHist = `<p>La Manito Del Vegano nació de una convicción profunda: que la alimentación plant based puede ser deliciosa, accesible y llena de amor. Desde nuestra cocina en Santiago, elaboramos cada producto con ingredientes 100% vegetales.</p>
...
const newHist = `<p><strong>La Manito Del Vegano</strong> nació de una convicción profunda: que la alimentación <em>plant based</em> puede ser deliciosa, accesible y llena de amor. Todo comenzó en nuestra cocina, buscando alternativas éticas que no sacrificaran el sabor de la comida tradicional chilena.</p>
