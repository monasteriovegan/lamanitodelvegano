...
-- Follow-up for environments where the initial handoff migration was already
-- applied: omnichannel_messages does not contain external_user_id. The
-- canonical WhatsApp counterparty/phone lives on conversations.external_conversation_id.
